...
// const ViewPaymentsAndRefundsForWrestler = (props: IProps) => {
//   const [allWrestlersInTenant, setAllWrestlersInTenant] = useState<any[]>();
//   const [userIdToFind, setUserIdToFind] = useState<number>();
//   const [allPaymentsForUser, setAllPaymentsForUser] =
//     useState<IPaymentsAndPurchases[]>();
...
//       }),
//     };
//     fetch(`/api/payments/getAllPaymentsAndDetailsForUserId`, requestOptions2)
//       .then((res) => res.json())
//       .then((res) => {
...
//                     return (
//                       <tr key={`payments-header-${payment.paymentsId}`}>
//                         <PaymentAndRefundCard paymentDetails={payment} />
//                       </tr>
//                     );
//                   })}
//                 </tbody>
...
// export default ViewPaymentsAndRefundsForWrestler;
// interface IProps {}
