...
import LessonPlanOverview from "./components/LessonPlanOverview";
...
let PlayLessonPlanStartPage = () => {
  ...
  React.useEffect(() => {
    fetch(`/api/lessonplans/getLessonPlanInfo/${planId.planId}`) // try to upack this and rename it it look horrible
      .then((res) => res.json())
      .then((res: IPlanInfo[]) =>
      ...
      <div className="m-3">
        ...
        <>
          {/* <div className="d-flex justify-content-between">
            <Link
              to={`/playEntireLessonPlan/${planId.planId}`}
